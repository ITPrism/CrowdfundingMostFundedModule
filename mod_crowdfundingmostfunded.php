...
JLoader::register('CrowdfundingMostFundedModuleHelper', JPATH_ROOT .'/modules/mod_crowdfundingmostfunded/helper.php');
...
$projects           = CrowdfundingMostFundedModuleHelper::getProjects($limitResults);
...
if (count($projects) > 0) {
    require JModuleHelper::getLayoutPath('mod_crowdfundingmostfunded', $params->get('layout', 'default'));
}
