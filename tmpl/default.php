...
$doc->addStyleSheet('modules/mod_crowdfundingmostfunded/css/style.css');
?>
<div class="cf-mod-mostfunded<?php echo $moduleclassSfx; ?>">
    <div class="row">
        <div class="col-md-12">
        ...
        $projectClass = 'cf-mmfv-project-100';
        if (count($image) > 0) {
            $projectClass = 'cf-mmfv-project-80';
        }
        ...
        <div>
            ...
            <div class="<?php echo $projectClass; ?>">
                ...
                <?php echo JText::sprintf('MOD_CROWDFUNDINGMOSTFUNDED_BY_S', $profileName); ?>
                </span>
                <?php } ?>
                ...
                <p class="font-small"><?php echo htmlspecialchars($description, ENT_QUOTES, 'UTF-8'); ?>
                    <?php if ($displayReadon) { ?>
                        <a href="<?php echo $projectLink; ?>" rel="nofollow"><?php echo JText::_('MOD_CROWDFUNDINGMOSTFUNDED_READON'); ?></a>
                    <?php } ?>
                </p>
                <?php } ?>

                <?php if ($displayInfo) { ?>
                <p class="font-xxsmall"><?php echo JText::sprintf('MOD_CROWDFUNDINGMOSTFUNDED_STARTED_ON', $startingDate, $endingDate); ?></p>
                <p class="font-xxsmall"><?php echo JText::sprintf('MOD_CROWDFUNDINGMOSTFUNDED_GOAL', $money->setAmount($project->goal)->formatCurrency(), $money->setAmount($project->funded)->formatCurrency()); ?></p>
                <?php } ?>
            </div>
    ...
    <div class="row">
        ...
        <a href="<?php echo JRoute::_(CrowdfundingHelperRoute::getDiscoverRoute()); ?>" rel="nofollow" class="btn btn-primary btn-lg"><?php echo JText::_('MOD_CROWDFUNDINGMOSTFUNDED_SEE_PROJECTS'); ?></a>
        </div>
    </div>
    <?php } ?>
</div>