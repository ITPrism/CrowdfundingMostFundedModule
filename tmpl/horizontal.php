...
<div class="cf-mod-mostfunded<?php echo $moduleclassSfx; ?>">
    ...
    <?php foreach ($projects as $project) {
        ...
        <div class="col-md-<?php echo $itemSpan; ?>">
            ...
            <div class="thumbnail cf-mmfh-project">
                ...
                <?php if ($displayInfo) { ?>
                <div class="cf-mmfh-caption-info absolute-bottom">
                    ...
                    <div class="row">
                        <div class="col-sm-4 hidden-xs">
                            ...
                            <div class="text-uppercase"><?php echo JText::_('MOD_CROWDFUNDINGMOSTFUNDED_FUNDED'); ?></div>
                        </div>
                        <div class="col-sm-4 col-xs-6">
                            <div class="bolder"><?php echo $raised; ?></div>
                            <div class="text-uppercase"><?php echo JText::_('MOD_CROWDFUNDINGMOSTFUNDED_RAISED'); ?></div>
                        </div>
                        <div class="col-sm-4 col-xs-6">
                            <div class="bolder"><?php echo $daysLeft; ?></div>
                            <div class="text-uppercase"><?php echo JText::_('MOD_CROWDFUNDINGMOSTFUNDED_DAYS_LEFT'); ?></div>
                        </div>
                    </div>
                <?php } ?>
                </div>
